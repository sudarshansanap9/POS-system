...
<!-- Modal -->
<div class="modal fade" id="addCustomerModal" data-bs-backdrop="static" data-bskeybord="false" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                     ...
                                     <tbody>
                                        <tr>
                                            <td style="text-align: center;" colspan="2">
                                               ...
                                               <p style="font-size: 16px; line-height: 24px; margin: 2px; padding: 0;">#999 1st stress, 3rd cross</p>
                                        ...
                                        <tr>
                                            ...
                                            <td align="end">
                                               ...
                                               <p style="font-size: 14px; line-height: 20px; margin: 0px; padding: 0;">Adress: 1st main road, banglore, India</p>      
                                            </td>
                                        </tr>
                                     </tbody>                                 
                                </table>
